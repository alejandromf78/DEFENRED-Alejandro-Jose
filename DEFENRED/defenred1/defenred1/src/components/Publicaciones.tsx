...
const Publicaciones = () => {
  return (
    <div>
      <h2>
        Publicaciones sobre <strong>Derechos Humanos</strong>
      </h2>
      <h3>
      ...
      <p>
        ...
        pasión de sus sueños, problemas y cómo superaron las dificultades. Cada
        historia nos anima a pensar y sentir para que todos podamos ayudar a
        hacer del mundo un lugar mejor y más amable.
      </p>
      <p>
        El libro está escrito por <strong>Loreto Rodríguez de Rivera</strong> y{" "}
      ...
      <p>
        ...
        >
          Más información sobre la <strong>Casa de Respiro</strong>
        </a>
      </p>
    </div>
  );
