    ...
    <>
      <footer className="footer-entero">
        <div className=" grid-33">
          ...
          <div className="redes-sociales">
            ...
            <div className="iconos">
              <a href="#">
                <img
                  src="/medios/Fotografías e ilustraciones/Instagram_icon.png"
                  alt="Instagram"
                  className="iconos"
                />
              </a>
              <a href="#">
                <img
                  src="/medios/Fotografías e ilustraciones/Facebook_Logo.png"
                  alt="Facebook"
                  className="iconos"
                />
              </a>
              <a href="#">
                <img
                  src="/medios/Fotografías e ilustraciones/X_icon.png"
                  alt="X"
                  className="iconos"
                />
              </a>
              <a href="#">
                <img
                  src="/medios/Fotografías e ilustraciones/youtube_icon.png"
                  alt="Youtube"
                  className="iconos"
                />
              </a>
        ...
        <div className="creado-por">
          <p>
            Website by Jose Andres y Alejandro Masó | &copy; 2025 Protection
            International
          </p>
        </div>
      </footer>
